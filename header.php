                    ...
                    echo
                        '<div class="row" style="padding:18px">'.
                            '<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">'.
                                '<p style="font-size:30px;">¡ Bienvenido '.$_SESSION['Nombre']. ' !</p>'.
                                '<a href="logoutProcess.php" type="button" class="boton btn-primary btn-md" style="text-transform: capitalize">'.
                            '</div>'.
                            '<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">'.
