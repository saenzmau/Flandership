...
<div class="wrapper bgded" style="background-image:url('images/CarritoRapido.jpg');">
  <div id="pageintro" class="hoc clear"> 
    ...
    <div class="flexslider basicslider"> 
      <ul class="slides">
        <li>
          <article>
            <h3 class="heading" style="font-family: 'Anton', sans-serif;">Catálogo</h3>
            <p><b>Conoce nuestros productos al mejor precio</b></p>
            <footer><a class="btn" href="#">Ver Catálogo</a></footer>
          </article>
        </li>
        <li>
          <article>
...
<div class="wrapper bgded overlay" style="background-color:black;">
  <main class="hoc container clear" style="color:white"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
...
<div class="wrapper row4 bgded overlay" style="background-color:black;">
  <footer id="footer" class="hoc clear" style="color:white"> 
    <!-- ################################################################################################ -->
...
<div class="wrapper row5" style="color:white" >
  <div id="copyright" class="hoc clear" > 
    <!-- ################################################################################################ -->
    <p class="fl_left"  >Copyright &copy; 2019 - All Rights Reserved - <a href="index.php" style="color:white" >Flandership</a></p>
    <p class="fl_right">Template by <a target="_blank" href="http://www.os-templates.com/" title="Free Website Templates" style="color:white" >OS Templates</a></p>
    <!-- ################################################################################################ -->
  </div>
</div>
<!-- ################################################################################################ -->
